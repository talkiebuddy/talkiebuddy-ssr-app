<template>
  <fieldset :class="classes">
    <div class="u-form-field__label">
      <a-label v-if="label" :html-for="`#card-number${uid}`" :required="required">
        {{ label }}
      </a-label>
    </div>
    ...
    <div class="m-form-credit-card-number__field u-form-field__input">
      ...
      <transition name="fade">
        <a-icon v-if="creditCard.type" :name="creditCard.type ? `credit-card-${creditCard.type.type}` : ''" size="medium" />
      </transition>
    </div>
